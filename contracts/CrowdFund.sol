...
contract CrowdFund{
    struct Campaign{
        ...
        uint goal; // mục tiêu
        uint pledged; // số tiền ủng hộ
        uint32 startAt; // thời gian bắt đầu
        uint32 endAt; // thời gian kết thúc
        bool claimed; // chiến dịch thành công/ thất bại
    }
    ...
    function claim(uint _id) external{
        ...
        require(campaign.goal <= campaign.pledged, "goal > pledged");
        require(!campaign.claimed, "Campaign is claimed");
